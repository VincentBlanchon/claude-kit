...
|---|---|---|
| [playbook/](playbook/README.md) | La méthode en 10 chapitres : piloter un agent, CLAUDE.md, workflow, vérification, contexte, hooks, git, design, coûts | (lecture, pas installé) |
...
| [hooks/](hooks/) | 4 scripts d'enforcement automatique : diagnostic git à l'ouverture, lint/format après édition, blocage de `--no-verify`, typecheck à l'arrêt | `~/.claude/hooks/` |
